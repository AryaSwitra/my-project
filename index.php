                ...
                <ul class="navbar-nav ml-auto">
                    <li class="dropdown nav-item">
                      ...
                      <div class="dropdown-menu dropdown-with-icons">
                        <a href="ubah.php" class="dropdown-item">
                            <i class="material-icons">layers</i> Edit Data
                        </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="cek_logout.php">
                            <i class="material-icons">cloud_download</i> Log Out
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                       <div class="profile">
                            <div class="avatar">
                                <img src="../images/<?=$cari['gambar']?>" alt="Circle Image" width=" 350px; height: 350px; border-radius: 50%;" class="rounded" >
                            </div>
                            <div class="name">
                                <h3 class="title"><?= $cari['nama'] ?></h3>
                                <h6><?= $cari['Jenis_kelamin'] ?></h6>
            ...
            <div class="row">
                    <div class="col-md-6 ml-auto mr-auto">
                        <div class="profile-tabs">
                          <ul class="nav nav-pills nav-pills-icons justify-content-center" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" href="snake.html" role="tab" style="color: red">
                                  <i class="material-icons">camera</i>
                                  Play The Game
                                </a>
                            </li>
